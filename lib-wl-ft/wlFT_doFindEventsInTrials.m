...
% FIXME - This is a cut-and-paste copy of the _MT version!
% Refactor both of these to put common code in helper functions.
...
% Using "for" instead of "parfor". That was the only change.
